    ...
    agents: [
      {
        ...
        state: "FL",
        reviewsCount: 375,
        bio: "Ryan Atkins is a licensed AmeriLife agent serving the Winter Haven area. He specializes in Medicare and retirement solutions, helping clients navigate their options with clarity and confidence.",
      ...
      },
      {
        ...
        state: "FL",
        reviewsCount: 375,
        bio: "Agatha Constanza is a dedicated AmeriLife agent committed to helping individuals and families find the right insurance and retirement plans. She brings compassion and expertise to every client interaction.",
        areasOfFocus: DEFAULT_AREAS_OF_FOCUS,
      },
      {
        slug: "william-primus",
