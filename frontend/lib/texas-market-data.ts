/** Headless WP media library — Texas headshots (`/texas/`). */
const WP_TEXAS_HEADSHOTS =
...
export type TexasMarketOffice = {
  ...
  email: string;
  phoneDisplay: string;
  /** Staff headshot — headless media (see WP_TEXAS_HEADSHOTS) */
  photoUrl: string;
...
export const TEXAS_MARKET_OFFICES: TexasMarketOffice[] = [
  {
    ...
    photoUrl: `${WP_TEXAS_HEADSHOTS}/travis-frier-headshot-300px.png`,
  ...
  },
  {
    ...
    photoUrl: `${WP_TEXAS_HEADSHOTS}/daniel-coffman-headshot-300px.png`,
  ...
  },
  {
    ...
    photoUrl: `${WP_TEXAS_HEADSHOTS}/todd-wechter-headshot-300px.png`,
  ...
  },
  {
    ...
    photoUrl: `${WP_TEXAS_HEADSHOTS}/anthony-burnley-headshot-300px.png`,
  ...
  },
  {
    ...
    photoUrl: `${WP_TEXAS_HEADSHOTS}/Campbell-Kathy_headshot-HR-300x300-1.jpg`,
  ...
  },
  {
    ...
    photoUrl: `${WP_TEXAS_HEADSHOTS}/8854d1a5-df78-4db8-8d61-733037779819-supporting_files-IMG_7209-e1724264028118.jpeg`,
