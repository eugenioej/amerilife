...
export const metadata: Metadata = staticPageMetadata(
  ...
  "AmeriLife SMS Text Messaging Terms and Conditions — how we use SMS text messaging, opt-in, opt-out, and data practices.",
  "/sms-text-messaging-terms-and-conditions/"
);

const BREADCRUMB: { name: string; path: string }[] = [
  { name: "Home", path: "/" },
  { name: "SMS Text Messaging Terms and Conditions", path: "/sms-text-messaging-terms-and-conditions/" },
];

export default function SmsTextMessagingTermsPage() {
  return (
    <>
      <JsonLd schema={breadcrumbJsonLd(BREADCRUMB)} />
      <LegalPageLayout
        title="SMS Text Messaging Terms and Conditions"
        breadcrumb={[
          { label: "Home", href: "/" },
          { label: "SMS Text Messaging Terms and Conditions" },
        ]}
        amlPlainText
      >
        <p>
        ...
        <p>
          Opting in to receive marketing and non-marketing text messages is not required to purchase
          any products or services from AmeriLife. By providing your mobile number and opting in, you
          agree you have ownership rights or permission to use the number given to AmeriLife.
        </p>

        <p>
          You may opt out of these communications at any time by following the procedure established
          by the text message. For example, replying &quot;STOP&quot; to any message you received.
          After this, you will no longer receive messages from that particular short code. If you
          want to join again, you can sign up as you did the first time and AmeriLife will start
        ...
        <p>
          ...
          <Link href="/privacy-policy/">Privacy Policy</Link> at Amerilife.com/privacy-policy.
        </p>
        ...
        <p>
          ...
          into. If you have questions about your text or data plan, it is best to contact your
          wireless provider.
        </p>
        ...
        <p>
          By opting in, you accept to be bound by these SMS Terms. These SMS Terms do not supersede
          the terms contained in the Legal Notice at{" "}
          <Link href="/terms/">Amerilife.com/terms</Link>. In the event of any conflict between the
          SMS Terms and the Legal Notice, such conflict shall be determined and resolved in favor of
          the terms, conditions, and notices in the Legal Notice, which is controlling over the SMS
