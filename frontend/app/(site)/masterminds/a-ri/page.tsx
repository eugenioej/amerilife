...
const AgendaDays = [
  {
    ...
    items: [
      ...
      {
        text:
          "6:00 PM – 9:00 PM: Group Dinner at Forbici Modern Italian (approximately a 10-minute walk from the hotel).",
      },
    ],
  },
    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            text: "10:00 AM – 12:00 PM: Wholesaler Showdown",
            children: [
              {
                text: "Speaker: Brian Kunkel",
              },
      ...
      {
        text:
          "6:00 PM – 9:00 PM: Group Dinner at Juno and the Peacock (approximately a 15-minute walk from the hotel).",
      },
    ],
  },
