  ...
  return (
    <div className="mx-auto max-w-[var(--container-max)] px-[var(--container-padding-x)] py-16 lg:py-24">
      <div className="max-w-2xl">
        <div
          className="mb-6 inline-flex rounded-2xl bg-[var(--color-brand-primary)]/10 p-4 text-[var(--color-brand-primary)]"
          aria-hidden
        >
          <FileQuestion className="size-10 sm:size-12" strokeWidth={1.5} />
        </div>
