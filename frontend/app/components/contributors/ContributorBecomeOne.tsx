...
const BANNER = "https://headlessameril.wpenginepowered.com/wp-content/uploads/2026/06/AdobeStock_1818758041-1.png";
...
export function ContributorBecomeOne() {
  return (
    <div
      ...
      style={{
        backgroundImage: `url(${rewriteUploadsUrl(BANNER)})`,
      }}
    >

      {/* ✅ GRADIENT OVERLAY */}
      <div className="absolute inset-0 bg-[linear-gradient(90deg,#244260_18%,#004E7C_62%,#40A691_85%)] opacity-80" />
