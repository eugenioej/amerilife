#!/usr/bin/env bash
# Sync worksite-distribution page images to headless WP.
# Images: Barbara headshot, Worksite_Page_1, Worksite_Page_2
#
# Usage:
#   export HEADLESS_SFTP_USER="..." HEADLESS_SFTP_PASSWORD="..." HEADLESS_WP_APP_PASSWORD="..."
#   ./frontend/scripts/sync-worksite-distribution-images.sh

set -e

export SYNC_WP_IMAGES=1
export SYNC_WP_IMPORT_MEDIA_LIBRARY=1
export SYNC_WP_PAGE_URL="https://amerilife.com/about-us/our-distribution/worksite-distribution/"
