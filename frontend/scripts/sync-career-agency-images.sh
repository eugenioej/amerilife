#!/usr/bin/env bash
# Sync career-agency page images to headless WP.
# Images: Frank headshot, group/seminar photo, family/client meeting
#
# Usage:
#   export HEADLESS_SFTP_USER="..." HEADLESS_SFTP_PASSWORD="..." HEADLESS_WP_APP_PASSWORD="..."
#   ./frontend/scripts/sync-career-agency-images.sh

set -e

export SYNC_WP_IMAGES=1
export SYNC_WP_IMPORT_MEDIA_LIBRARY=1
export SYNC_WP_PAGE_URL="https://amerilife.com/about-us/our-distribution/career-agency/"
