#!/usr/bin/env bash
# Sync expectations-when-you-join-our-team page images to headless WP.
#
# Prereqs:
...
#   ./frontend/scripts/sync-expectations-images.sh
#
# Or inline (from project root):
#   HEADLESS_SFTP_USER=... HEADLESS_SFTP_PASSWORD=... HEADLESS_WP_APP_PASSWORD=... ./frontend/scripts/sync-expectations-images.sh
...
export SYNC_WP_PAGE_URL="https://amerilife.com/expectations-when-you-join-our-team/"
