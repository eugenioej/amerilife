#!/usr/bin/env bash
# Sync kickoff-recap-2025 page images to headless WP.
#
# Prereqs:
...
#   ./frontend/scripts/sync-kickoff-recap-images.sh
#
# Or inline (from project root):
#   HEADLESS_SFTP_USER=... HEADLESS_SFTP_PASSWORD=... HEADLESS_WP_APP_PASSWORD=... ./frontend/scripts/sync-kickoff-recap-images.sh
...
export SYNC_WP_PAGE_URL="https://amerilife.com/kickoff-recap-2025/"
